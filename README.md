...
[RS School NodeJS 2024](https://github.com/AlreadyBored/nodejs-assignments/blob/main/assignments/crud-api/assignment.md)

## To run app:

`https://github.com/MatsurSviat/node-crud-api.git`
